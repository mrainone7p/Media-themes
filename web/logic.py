...
def _validate_audio_ready(audio_path: str | Path) -> float:
    """Validate audio using strict shared checks, then return duration in seconds."""
...
def _parse_bool(value) -> bool:
    """Parse a truthy value to bool without error reporting (use _coerce_config_bool for validated config fields)."""
